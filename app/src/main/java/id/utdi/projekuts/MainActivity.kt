...
fun MovieCard() {
    ...
    val movies = listOf(
        Movie(R.drawable.ARI1, "Informasi tambahan Film 1", "Deskripsi Film 1"),
        Movie(R.drawable.ari2, "Informasi tambahan Film 2", "Deskripsi Film 2"),
        Movie(R.drawable.ari3, "Informasi tambahan Film 3", "Deskripsi Film 3"),
